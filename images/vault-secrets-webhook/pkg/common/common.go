...
const (
	...
	ServiceAccountTokenPathAnnotation   = "secrets-store.deckhouse.io/service-account-token-path"
	...
	RestartOnSecretChangeAnnotation     = "secrets-store.deckhouse.io/restart-on-secret-change"
	SecretPollIntervalAnnotation        = "secrets-store.deckhouse.io/secret-poll-interval"
)
