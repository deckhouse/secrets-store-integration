...
Основной механизм реализации — CSI. Для этого варианта [в сравнительной таблице](#сравнение-сценариев) указан сценарий, в котором приложение получает данные из дискового тома, а секрет в Kubernetes не хранится.
